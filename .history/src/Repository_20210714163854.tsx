...
export const Repository = ({ data, onFetchMoreIssues, onStar }: { data: RepoData, onFetchMoreIssues: () => void, onStar: () => void; }) => {
    ...
    return (
        <div>
            ...
            <button type="button" onClick={ onStar }>{ data.viewerHasStarred ? 'Unstar' : 'Star' }</button>
            <ul>
                {
